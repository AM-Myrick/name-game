    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                allEmployees = [];
                return [4 /*yield*/, axios_1.default.get("https://willowtreeapps.com/api/v1.0/profiles/")];
            case 1:
                response = _a.sent();
                allEmployees.push.apply(allEmployees, response.data);
...
exports.getMatEmployees = function (employees) {
    var matEmployees = employees.filter(function (employee) { return employee.firstName === "Mat" || employee.firstName === "Matt"; });
    return matEmployees;
};
exports.getFormerEmployees = function (employees) {
    var formerEmployees = employees.filter(function (employee) { return !employee.hasOwnProperty("jobTitle"); });
